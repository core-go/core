...
func AfterDeletedWithLog(ctx *gin.Context, count int64, err error, logError func(context.Context, string, ...map[string]interface{}), writeLog func(context.Context, string, string, bool, string) error, resource string, action string) {
	core.AfterDeletedWithLog(ctx.Writer, ctx.Request, count, err, logError, writeLog, resource, action)
}
func AfterDeleted(ctx *gin.Context, count int64, err error, logError func(context.Context, string, ...map[string]interface{})) {
	core.AfterDeleted(ctx.Writer, ctx.Request, count, err, logError)
}
...
func AfterSavedWithLog(ctx *gin.Context, body interface{}, count int64, err error, logError func(context.Context, string, ...map[string]interface{}), writeLog func(context.Context, string, string, bool, string) error, resource string, action string) {
	core.AfterSavedWithLog(ctx.Writer, ctx.Request, body, count, err, logError, writeLog, resource, action)
}
func AfterSaved(ctx *gin.Context, body interface{}, count int64, err error, logError func(context.Context, string, ...map[string]interface{})) {
	core.AfterSaved(ctx.Writer, ctx.Request, body, count, err, logError)
}
func AfterCreatedWithLog(ctx *gin.Context, body interface{}, count int64, err error, logError func(context.Context, string, ...map[string]interface{}), writeLog func(context.Context, string, string, bool, string) error, resource string, action string) {
	core.AfterCreatedWithLog(ctx.Writer, ctx.Request, body, count, err, logError, writeLog, resource, action)
}
func AfterCreated(ctx *gin.Context, body interface{}, count int64, err error, logError func(context.Context, string, ...map[string]interface{})) {
	core.AfterCreated(ctx.Writer, ctx.Request, body, count, err, logError)
}
