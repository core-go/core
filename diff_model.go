...
type DiffModel struct {
	...
	Value  interface{} `mapstructure:"value" json:"value,omitempty" gorm:"column:newvalue" bson:"value,omitempty" dynamodbav:"value,omitempty" firestore:"value,omitempty"`
}
