...
func NewApprHandler(apprService ApprService, modelType reflect.Type, resource string, logError func(context.Context, string), writeLog func(context.Context, string, string, bool, string) error, option ...int) *ApprHandler {
	...
	return &ApprHandler{Log: writeLog, ApprService: apprService, ModelType: modelType, IdNames: idNames, Indexes: indexs, Offset: offset, Resource: resource, Error: logError}
}
...
func (c *ApprHandler) Approve(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		if err != nil {
			Error(w, r, http.StatusOK, StatusError, c.Error, c.Resource, "approve", err, c.Log)
		} else {
...
func (c *ApprHandler) Reject(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		if err != nil {
			Error(w, r, http.StatusOK, StatusError, c.Error, c.Resource, "reject", err, c.Log)
		} else {
