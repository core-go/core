...
func (h *ApprHandler) Approve(w http.ResponseWriter, r *http.Request) {
	...
	if ok {
		...
		HandleResult(w, r, id, res, err, h.Resource, h.ActionApprove, h.LogError, h.WriteLog)
	}
}
func (h *ApprHandler) Reject(w http.ResponseWriter, r *http.Request) {
	...
	if ok {
		...
		HandleResult(w, r, id, res, err, h.Resource, h.ActionReject, h.LogError, h.WriteLog)
	}
}
